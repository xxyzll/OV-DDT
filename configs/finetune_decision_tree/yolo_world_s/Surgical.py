...
model_name = "gpt4o"
scale = 'yolo_world_s'
class_names = ['SuctionTube', 'Retractors', 'SuctionTubeSkeleton', 'BipolarForcepsUp', 'BipolarForcepsDown', 'PliersUp', 
               'PliersDown', 'BipolarForcepsUpSkeleton', 'Scissors', 'Hook', 'Scalpel', 'BipolarForcepsDOwn', 'Curette']
# hyper-parameters
...
load_from = f'/home/xx/YOLO-World/finetune_prompt/yolo_world_s/Surgical/epoch_80.pth'
