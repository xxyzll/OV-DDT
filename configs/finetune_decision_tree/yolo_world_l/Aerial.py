...
load_from = f'/home/xx/YOLO-World/finetune_prompt/{scale}/{dataset_name}/epoch_80.pth'
...
val_evaluator = dict(
    ...
    metric='bbox')
# add evaluator
json_prefix=f'{dataset_name}_OV_DDT'
test_evaluator=test_evaluator=dict(
    _delete_=True,
    type='mmdet.CocoMetric',
    proposal_nums=(100, 1, 10),
    ann_file=f'data/{dataset_name}/Annotations/{dataset_name}_test.json',
