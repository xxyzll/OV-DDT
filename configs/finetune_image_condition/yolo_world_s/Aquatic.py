...
# load_from = f'/home/xx/YOLO-World/finetune_prompt/yolo_world_s/Aquatic/epoch_80.pth'
# load_from =  '/home/xx/YOLO-World/pretrained_models/yolo_world_v2_l_obj365v1_goldg_pretrain-a82b1fe3.pth'
# load_from = '/home/xx/YOLO-World/work_dirs/Aquatic_yolo_world_l/epoch_80_full_finetune.pth'
...
model = dict(type='DecisionTreeYOLOWorld',
             ...
             embedding_path=f'/home/xx/YOLO-World/data/texts/{dataset_name}_image_condition_embeddings.npy',
             prompt_dim=text_channels,
             num_prompts=num_classes,  
             freeze_prompt=False,
             mode=mode,
             save_path=f'image_condition/yolo_world_s/{dataset_name}',
             data_preprocessor=dict(type='YOLOv5DetDataPreprocessor'),
             tree_path=f'data/texts/yolo_world_s_{dataset_name}_{model_name}_decision_tree.joblib',
             att_path=f'data/texts/{dataset_name}_{model_name}.npy',
             connections=f'data/texts/yolo_world_s_{dataset_name}_{model_name}_decision_tree.json',
