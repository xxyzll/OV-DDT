...
mode = "trainable_tree"
model_name = 'gpt4o'
class_names = ['golffield', 'Expressway-toll-station', 'vehicle', 'trainstation', 'chimney', 'storagetank', 'ship', 'harbor', 
               'airplane', 'groundtrackfield', 'tenniscourt', 'dam', 'basketballcourt', 'Expressway-Service-area', 'stadium', 
...
load_from = f'/home/xx/YOLO-World/finetune_prompt/yolo_world_s/Aerial/epoch_80.pth'
...
model = dict(type='DecisionTreeYOLOWorld',
             ...
             freeze_prompt=False,
             mode=mode,
             save_path=f'decision_tree/yolo_world_s/{dataset_name}',
