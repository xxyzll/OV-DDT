...
model_name = 'gpt4o'
class_names = ['x-ray-rheumatology', 'artefact', 'distal phalanges', 'fifth metacarpal bone', 
               'first metacarpal bone', 'fourth metacarpal bone', 'intermediate phalanges', 
...
model = dict(type='DecisionTreeYOLOWorld',
             ...
             freeze_prompt=False,
             mode='trainable_tree',
             save_path=f'decision_tree/{dataset_name}',
             data_preprocessor=dict(type='YOLOv5DetDataPreprocessor'),
             tree_path=f'data/texts/{dataset_name}_{model_name}_decision_tree.joblib',
             att_path=f'data/texts/{dataset_name}_{model_name}.npy',
            #  connections=f'data/texts/{dataset_name}_decision_tree_structure.json',
            connections=f'data/texts/{dataset_name}_{model_name}_decision_tree.json',
